PROJECT_NAME := Pulumi synadia-cloud Resource Provider

PACK             := synadia-cloud
PACKDIR          := sdk
PROJECT          := github.com/rebelopsio/pulumi-synadia-cloud
NODE_MODULE_NAME := @rebelopsio/synadia-cloud
NUGET_PKG_NAME   := rebelopsio.synadia-cloud
